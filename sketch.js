...
function preload()
{
  ...
  blank_star2 = loadAnimation("empty.png");
...
star2.scale=0.02
// star 3 
star3=createSprite(50,20,30,30);
star3.scale=0.2;
star3.addAnimation('empty_star',blank_star2);
star3.addAnimation('one_starc',one_star);
star3.addAnimation('star_two',star_2);
star3.changeAnimation('empty_star')
...
if(collide(fruit,star1,20)==true){
  star1.visible=false
 star3.changeAnimation('one_starc')

}
if(collide(fruit,star2,40)==true){
  star2.visible=false
 star3.changeAnimation('star_two')
